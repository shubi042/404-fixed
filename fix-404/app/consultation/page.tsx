        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="w-full">
              <iframe
                src={`https://calendly.com/${process.env.NEXT_PUBLIC_CALENDLY_USERNAME || 'services-tidymate'}/30min?embed_domain=${typeof window !== 'undefined' ? window.location.hostname : ''}&embed_type=Inline&hide_event_type_details=1&hide_gdpr_banner=1&primary_color=000000&text_color=4d4d4d`}
                width="100%"
                height="700"
                frameBorder="0"
                scrolling="no"
